...
public class PlaceholderHardwareMap extends LinearOpMode {
    public DcMotor LFMotor;
    public DcMotor RFMotor;
    public DcMotor LBMotor;
    public DcMotor RBMotor;
    public DcMotor MechLiftMotor;
    // Moves the lift mechanism; driver controlled
    ...
    static final double     LIFT_UP_SPEED           = 0.6;
    static final double     LIFT_DOWN_SPEED         = -0.6;
